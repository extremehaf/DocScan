...
public class CropActivity extends Activity {
     ...
     * Intents have crop_activity maximum of 1MB in total size. However, the Bitmap seems to
     * have some overhead to hit so that we go way below the limit here to make
     * sure the intent stays below 1MB.We should consider just returning crop_activity byte
     * array instead of crop_activity Bitmap instance to avoid overhead.
     */
    ...
    /**
     * Opens crop_activity selector in Gallery to chose an image for use when none was given
     * in the CROP intent.
     */
    ...
    /**
     * Method that loads crop_activity bitmap in an async task.
     */
    ...
    /**
     * AsyncTask for loading crop_activity bitmap into memory.
     *
    ...
    private class BitmapIOTask extends AsyncTask<Bitmap, Void, Boolean> {
        ...
        public BitmapIOTask(Uri sourceUri, Uri destUri, String outputFormat, int flags,
            ...
            mRotation %= 360;
            mRotation = 90 * (int) (mRotation / 90);  // now mRotation is crop_activity multiple of 90
            mOutputX = outputX;
            mOutputY = outputY;
        ...
        protected Boolean doInBackground(Bitmap... params) {
            ...
            if ((mFlags & (DO_EXTRA_OUTPUT | DO_SET_WALLPAPER)) != 0 && mInStream != null) {
                ...
                // Attempt to open crop_activity region decoder
                ...
                // If we only need to output to crop_activity URI, compress straight to file
                if (mFlags == DO_EXTRA_OUTPUT) {
                    ...
                    if (crop.compress(cf, DEFAULT_COMPRESS_QUALITY, tmpOut)) {
                        // If we need to output to crop_activity Uri, write compressed
                        // bitmap out
