...
public class CropMath {
    /**
     * Gets crop_activity float array of the 2D coordinates representing crop_activity rectangles
     * corners.
    ...
    /**
     * Takes crop_activity point and the corners of crop_activity rectangle and returns the two corners
    ...
    /**
     * Checks if crop_activity given point is within crop_activity rotated rectangle.
     *
     ...
     *
     * @param point 2D point to check
     * @param rotatedRect corners of crop_activity rotated rectangle
    ...
    /**
     * Resizes rectangle to have crop_activity certain aspect ratio (center remains
     * stationary).
     *
    ...
    /**
     * Returns the size of crop_activity bitmap in bytes.
