...
import com.android.camera.crop.Exif.ExifTag;
...
public final class ImageLoader {
    ...
    private ImageLoader() {}
    /**
     * Returns the Mime type for crop_activity Url.  Safe to use with Urls that do not
    ...
    /**
     * Takes an orientation and crop_activity bitmap, and returns the bitmap transformed
     * to that orientation.
     */
    ...
    /**
     * Returns the bounds of the bitmap stored at crop_activity given Url.
     */
    ...
    /**
     * Loads crop_activity bitmap that has been downsampled using sampleSize from crop_activity given url.
     */
    ...
    /**
     * Loads crop_activity bitmap at crop_activity given URI that is downsampled so that both sides are
    ...
    /**
     * Loads crop_activity bitmap that is downsampled by at least the input sample size. In
    ...
    /**
     * Loads bitmap from crop_activity resource that may be downsampled in low-memory situations.
     */
