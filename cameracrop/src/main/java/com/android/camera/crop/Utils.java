...
public class Utils {
    ...
    // Throws AssertionError with the message. We had crop_activity method having the form
    //   assertTrue(boolean cond, String message, Object ... args);
    // However crop_activity call to that method will cause memory allocation even if the
    ...
    /**
     * A function thats returns crop_activity 64-bit crc for string
     *
     * @param in input string
     * @return crop_activity 64-bit crc value
     */
    ...
    // for debugging build (i.e., 'eng' and 'userdebug') and returns crop_activity mask ("****")
